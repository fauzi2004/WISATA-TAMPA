...
<body class="bg-cover bg-center min-h-screen flex items-center justify-center py-12 px-4 relative overflow-x-hidden" style="background-image: url('<?= base_url('assets/images/tentang-desa.png') ?>');">
    ...
    <div class="max-w-md w-full bg-white/10 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.5)] p-6 md:p-10 relative z-10 border border-white/20 hover:border-white/30 transition-colors duration-500">
        ...
        <div class="text-center mb-10">
            ...
            <h2 class="text-4xl font-black text-white tracking-tight drop-shadow-md">Login</h2>
            <p class="text-gray-300 mt-2 font-medium">Masuk ke akun Wisata Desa Tampa</p>
        </div>
        ...
        <form action="<?= base_url('login/process') ?>" method="POST">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-2 ml-1">
                    <label for="password" class="block text-gray-200 font-bold">Password</label>
                    <a href="<?= base_url('lupa-password') ?>" class="text-sm font-bold text-emerald-400 hover:text-emerald-300 transition-colors drop-shadow-sm hover:underline">Lupa Password?</a>
                </div>
                <div class="relative group/input">
                    <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within/input:text-emerald-400 transition-colors">
        ...
        <div class="mt-8 pt-6 border-t border-white/10 text-center">
            <p class="text-gray-300 text-sm font-medium">
                Belum punya akun? 
                <a href="<?= base_url('register') ?>" class="text-emerald-400 hover:text-emerald-300 font-bold hover:underline transition-colors">Register di sini</a>
            </p>
